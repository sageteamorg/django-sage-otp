...
1. **Fork and Clone**: Fork the repository and clone it to your local machine.
    ```bash
    git clone https://github.com/<your-username>/django-sage-otp.git
    cd django-sage-otp
    ```
...
6. **Run Code Quality Checks**: Ensure code quality with pre-commit, Ruff, and Pylint.
    ...
    poetry run ruff check sage_otp/ --fix
    poetry run black sage_otp/
    poetry run isort sage_otp/
    poetry run pylint sage_otp/
    poetry run bandit -r sage_otp/ -c pyproject.toml
    ```
